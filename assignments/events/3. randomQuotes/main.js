...
let quot = document.createElement("div");
document.body.append(quot);


function randomQuotes() {
	let Greatnerate = getRandom(0, quotes.length - 1);
	quot.textContent = quotes[Greatnerate]["quoteText"] + "-" + quotes[Greatnerate]["quoteAuthor"];
}
